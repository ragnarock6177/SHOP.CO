...
const MOCK_PRODUCTS = [
  ...
  },
  {
    ...
    description:
      "Featuring an eye-catching gradient art design on premium combed cotton.",
    price: 145,
    originalPrice: 242,
    discount: 20,
    rating: 3.5,
  ...
  },
  {
    ...
    description:
      "Classic polo shirt enhanced with contrasting collar tipping details.",
    price: 180,
    originalPrice: 242,
    discount: 20,
    rating: 4.5,
    ...
    category: "casual",
    image:
      "https://images.unsplash.com/photo-1625910513413-43d94eb38e21?auto=format&fit=crop&q=80&w=800",
