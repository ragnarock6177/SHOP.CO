...
export const AuditDiffModal: React.FC<AuditDiffModalProps> = ({ log, isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
      <div className="w-full max-w-lg space-y-4 rounded-2xl border border-slate-200/80 bg-white p-6 shadow-xs">
        ...
        <div className="space-y-1">
          ...
          <pre className="max-h-60 overflow-y-auto rounded-lg border border-slate-200 bg-white p-3 font-mono text-[11px] text-emerald-400">
