  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
      <div className="w-full max-w-md space-y-4 rounded-xl border border-zinc-800 bg-zinc-900 p-6 shadow-2xl">
        <h3 className="text-base font-semibold text-zinc-100">Create Promotional Coupon</h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-3 text-xs">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-zinc-800 bg-zinc-950 px-3 py-2 font-mono text-zinc-100 uppercase focus:outline-none"
              required
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-zinc-300 font-semibold mb-1">Min Subtotal (₹)</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-zinc-300 font-semibold mb-1">Usage Limit</label>
              <input
                type="number"
                value={usageLimit}
          ...
          <div>
            <label className="block text-zinc-300 font-semibold mb-1">Start Date</label>
            <input
              type="date"
              value={startDate}
