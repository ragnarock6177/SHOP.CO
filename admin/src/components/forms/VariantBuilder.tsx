        ...
        <div className="space-y-3 rounded-md border border-slate-200 bg-white p-4">
          ...
          <div className="flex flex-wrap gap-2">
            {colors.map((c) => (
              <div
                key={c.name}
                className="inline-flex items-center gap-2 rounded-md border border-slate-200 bg-slate-50 px-3 py-1.5 text-xs font-semibold text-slate-800 shadow-2xs"
              >
                <span
                  className="h-3.5 w-3.5 rounded-md border border-slate-300 shadow-2xs shrink-0"
          ...
          <div className="pt-2">
            <div className="flex flex-wrap gap-1.5 mb-3">
              {PRESET_COLORS.filter((pc) => !colors.some((c) => c.name === pc.name)).map((pc) => (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-md border border-slate-200 bg-white px-2 py-1 text-[10px] font-medium text-slate-600 hover:bg-slate-50 transition cursor-pointer"
                >
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="h-8 w-8 cursor-pointer rounded-md border border-slate-200 p-0.5"
              />
              <input
                type="text"
                ...
                className="flex-1 rounded-md border border-slate-200 px-3 py-1.5 text-xs focus:border-slate-400 focus:ring-1 focus:ring-slate-400"
              />
              <button
                type="button"
        ...
        <div className="space-y-3 rounded-md border border-slate-200 bg-white p-4">
          ...
          <div className="flex flex-wrap gap-2">
            {sizes.map((s) => (
              <div
                key={s}
                className="inline-flex items-center gap-1.5 rounded-md border border-slate-200 bg-slate-50 px-3 py-1.5 text-xs font-bold text-slate-800 shadow-2xs"
              >
                <span>{s}</span>
                <button
                  type="button"
          ...
          <div className="pt-2">
            <div className="flex flex-wrap gap-1.5 mb-3">
              {PRESET_SIZES.filter((ps) => !sizes.includes(ps)).map((ps) => (
                <button
                  ...
                  className="inline-flex items-center gap-1 rounded-md border border-slate-200 bg-white px-2 py-1 text-[10px] font-medium text-slate-600 hover:bg-slate-50 transition cursor-pointer"
                >
                  <Plus className="h-3 w-3" />
                  {ps}
                </button>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 rounded-md border border-slate-200 px-3 py-1.5 text-xs focus:border-slate-400 focus:ring-1 focus:ring-slate-400 uppercase"
              />
              <button
                type="button"
        ...
        <div className="space-y-4 pt-4 border-t border-slate-200">
          <div className="flex items-center justify-between mb-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-md bg-slate-100 px-3 py-1.5 text-xs font-semibold text-slate-700 hover:bg-slate-200 transition"
            >
          ...
          <div className="space-y-6">
            {colors.map((color) => {
              ...
              return (
                <div key={color.name} className="rounded-md border border-slate-200 bg-white p-5 shadow-sm">
                  
                  {/* Group Header */}
                  <div className="flex items-center gap-3 mb-5 border-b border-slate-100 pb-3">
                    <span className="h-4 w-4 rounded-md border border-slate-200 shadow-2xs" style={{ backgroundColor: color.hex }} />
                  ...
                  <div className="flex flex-col md:flex-row items-start gap-6">
                    ...
                    <div className="flex-1 w-full space-y-3">
                      {colorVariants.map((v) => (
                        <div key={v.id} className="relative rounded-md border border-slate-200 bg-slate-50/50 p-4 transition-colors hover:border-slate-300">
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pr-6">
                            ...
                            <div className="col-span-2 md:col-span-4 flex items-center justify-between mb-1">
                              <span className="inline-flex items-center gap-1.5 rounded-md bg-slate-200 px-2.5 py-1 text-xs font-bold text-slate-800">
                                Size: {v.sizeName}
                              </span>
                              <button
                                type="button"
                            ...
                            <div>
                              ...
                              <input
                                ...
                                className="w-full rounded-md border border-slate-200 px-3 py-1.5 text-sm text-slate-900 focus:border-slate-400 focus:ring-1 focus:ring-slate-400 bg-white"
                              />
                            </div>
                            ...
                            <div>
                              ...
                              <input
                                ...
                                className="w-full rounded-md border border-slate-200 px-3 py-1.5 text-sm font-semibold text-slate-600 bg-slate-100 focus:border-slate-400 focus:ring-1 focus:ring-slate-400"
                              />
                            </div>
                          </div>
                        </div>
