...
- [ ] **T001** `[Phase 1]` Create Admin base router structure in `backend/src/routes/admin/index.ts` mounting under `/api/v1/admin`.
...
- [ ] **T002** `[P]` `[Phase 1]` Implement Admin status authentication middleware in `backend/src/middleware/adminAuth.ts`.
...
- [ ] **T003** `[P]` `[Phase 1]` Implement Granular RBAC Permission Middleware `requirePermission` in `backend/src/middleware/rbac.ts`.
...
- [ ] **T004** `[P]` `[Phase 1]` Implement Admin Query Parameter Sanitizer in `backend/src/utils/adminQueryParams.ts`.
...
- [ ] **T005** `[P]` `[Phase 1]` Standardize Admin Response Helper formatting in `backend/src/utils/adminResponse.ts`.
...
- [ ] **T006** `[Phase 2]` `[US1]` Implement Admin User List API `GET /api/v1/admin/admin-users`.
...
- [ ] **T007** `[Phase 2]` `[US1]` Implement Admin User Create & Update APIs `POST` & `PUT /api/v1/admin/admin-users`.
...
- [ ] **T008** `[Phase 2]` `[US1]` Implement Roles List & Detail API `GET /api/v1/admin/roles`.
...
- [ ] **T009** `[Phase 2]` `[US1]` Implement Role Create & Permission Mutation API `POST` & `PUT /api/v1/admin/roles/:id`.
...
- [ ] **T010** `[P]` `[Phase 2]` `[US1]` Implement Permissions Directory API `GET /api/v1/admin/permissions`.
...
- [ ] **T011** `[Phase 2]` `[US1]` Implement User Status Toggle API `PATCH /api/v1/admin/admin-users/:id/status`.
...
- [ ] **T012** `[Phase 3]` `[US2]` Implement Dashboard Metrics Aggregation Service in `backend/src/services/admin/dashboard.service.ts`.
...
- [ ] **T013** `[Phase 3]` `[US2]` Implement Dashboard Summary Endpoint `GET /api/v1/admin/dashboard`.
...
- [ ] **T014** `[P]` `[Phase 3]` `[US2]` Add Recent Audit Trail Widget to Dashboard API payload.
...
- [ ] **T015** `[Phase 4]` `[US1]` Implement Admin Product List API `GET /api/v1/admin/products`.
...
- [ ] **T016** `[Phase 4]` `[US1]` Implement Admin Product Details API `GET /api/v1/admin/products/:id`.
...
- [ ] **T017** `[Phase 4]` `[US1]` Implement Product Creation API `POST /api/v1/admin/products`.
...
- [ ] **T018** `[Phase 4]` `[US1]` Implement Product Mutation API `PUT /api/v1/admin/products/:id`.
...
- [ ] **T019** `[P]` `[Phase 4]` `[US1]` Implement Categories Management APIs `GET`, `POST`, `PUT /api/v1/admin/categories`.
...
- [ ] **T020** `[P]` `[Phase 4]` `[US1]` Implement Collections Management APIs `GET`, `POST`, `PUT /api/v1/admin/collections`.
...
- [ ] **T021** `[P]` `[Phase 4]` `[US1]` Implement Attributes & Values APIs `GET`, `POST`, `PUT /api/v1/admin/attributes`.
...
- [ ] **T022** `[Phase 4]` `[US1]` Implement Product Variant Management APIs `POST`, `PUT /api/v1/admin/products/:id/variants`.
...
- [ ] **T023** `[P]` `[Phase 4]` `[US1]` Implement Product Media Gallery APIs `POST`, `PUT`, `DELETE /api/v1/admin/products/:id/images`.
...
- [ ] **T024** `[Phase 4]` `[US1]` Implement Product Status Archive API `DELETE /api/v1/admin/products/:id`.
...
- [ ] **T025** `[Phase 5]` `[US3]` Implement Inventory List API `GET /api/v1/admin/inventory`.
...
- [ ] **T026** `[Phase 5]` `[US3]` Implement Transaction-Safe Stock Adjustment API `POST /api/v1/admin/inventory/adjust`.
...
- [ ] **T027** `[P]` `[Phase 5]` `[US3]` Implement Inventory Movements History API `GET /api/v1/admin/inventory/movements`.
...
- [ ] **T028** `[P]` `[Phase 5]` `[US3]` Implement Active Inventory Reservations View API `GET /api/v1/admin/inventory/reservations`.
...
- [ ] **T029** `[Phase 5]` `[US3]` Implement Inventory Threshold Settings API `PUT /api/v1/admin/inventory/:id/threshold`.
...
- [ ] **T030** `[Phase 6]` `[US1]` Implement Customer Directory API `GET /api/v1/admin/customers`.
...
- [ ] **T031** `[Phase 6]` `[US1]` Implement Customer Profile Details API `GET /api/v1/admin/customers/:id`.
...
- [ ] **T032** `[Phase 6]` `[US1]` Implement Customer Account Status Operation API `PATCH /api/v1/admin/customers/:id/status`.
...
- [ ] **T033** `[P]` `[Phase 6]` `[US1]` Implement Customer Order History API `GET /api/v1/admin/customers/:id/orders`.
...
- [ ] **T034** `[Phase 7]` `[US2]` Implement Admin Order List API `GET /api/v1/admin/orders`.
...
- [ ] **T035** `[Phase 7]` `[US2]` Implement Admin Order Details API `GET /api/v1/admin/orders/:id`.
...
- [ ] **T036** `[Phase 7]` `[US2]` Implement State Machine Transition Validator `validateOrderTransition` in `backend/src/services/admin/orders.service.ts`.
...
- [ ] **T037** `[Phase 7]` `[US2]` Implement Order Status Shift API `PATCH /api/v1/admin/orders/:id/status`.
...
- [ ] **T038** `[P]` `[Phase 7]` `[US2]` Implement Order Status History Stream API `GET /api/v1/admin/orders/:id/history`.
...
- [ ] **T039** `[Phase 7]` `[US2]` Implement Order Cancellation & Stock Release Action in `backend/src/services/admin/orders.service.ts`.
...
- [ ] **T040** `[Phase 8]` `[US2]` Implement Shipment Generation API `POST /api/v1/admin/shipments`.
...
- [ ] **T041** `[P]` `[Phase 8]` `[US2]` Implement Admin Shipment List API `GET /api/v1/admin/shipments`.
...
- [ ] **T042** `[Phase 8]` `[US2]` Implement Shipment Status Shift API `PATCH /api/v1/admin/shipments/:id/status`.
...
- [ ] **T043** `[P]` `[Phase 8]` `[US2]` Implement Shipment Details & Tracking API `GET /api/v1/admin/shipments/:id`.
...
- [ ] **T044** `[P]` `[Phase 9]` `[US1]` Implement Payment Oversight List API `GET /api/v1/admin/payments`.
...
- [ ] **T045** `[P]` `[Phase 9]` `[US1]` Implement Payment Transactions Log API `GET /api/v1/admin/payments/:id/transactions`.
...
- [ ] **T046** `[P]` `[Phase 9]` `[US1]` Implement Invoice List API `GET /api/v1/admin/invoices`.
...
- [ ] **T047** `[P]` `[Phase 9]` `[US1]` Implement Invoice PDF Generation Endpoint `GET /api/v1/admin/invoices/:id/pdf`.
...
- [ ] **T048** `[Phase 10]` `[US1]` Implement Coupon List API `GET /api/v1/admin/coupons`.
...
- [ ] **T049** `[Phase 10]` `[US1]` Implement Coupon Creation API `POST /api/v1/admin/coupons`.
...
- [ ] **T050** `[Phase 10]` `[US1]` Implement Coupon Product/Category Scope Assignment API `PUT /api/v1/admin/coupons/:id/scope`.
...
- [ ] **T051** `[P]` `[Phase 10]` `[US1]` Implement Coupon Usage History API `GET /api/v1/admin/coupons/:id/usages`.
...
- [ ] **T052** `[P]` `[Phase 10]` `[US1]` Implement Coupon Toggle Status API `PATCH /api/v1/admin/coupons/:id/status`.
...
- [ ] **T053** `[P]` `[Phase 11]` `[US1]` Implement Review Moderation List API `GET /api/v1/admin/reviews`.
...
- [ ] **T054** `[Phase 11]` `[US1]` Implement Review Publish Toggle API `PATCH /api/v1/admin/reviews/:id/publish`.
...
- [ ] **T055** `[P]` `[Phase 11]` `[US1]` Implement Review Soft Delete API `DELETE /api/v1/admin/reviews/:id`.
...
- [ ] **T056** `[P]` `[Phase 11]` `[US1]` Implement Review Details API `GET /api/v1/admin/reviews/:id`.
...
- [ ] **T057** `[Phase 12]` `[US4]` Implement Return Requests List API `GET /api/v1/admin/returns`.
...
- [ ] **T058** `[Phase 12]` `[US4]` Implement Return Details & Items Inspection API `GET /api/v1/admin/returns/:id`.
...
- [ ] **T059** `[Phase 12]` `[US4]` Implement Return Status Shift API `PATCH /api/v1/admin/returns/:id/status`.
...
- [ ] **T060** `[P]` `[Phase 12]` `[US4]` Implement Refund List API `GET /api/v1/admin/refunds`.
...
- [ ] **T061** `[Phase 12]` `[US4]` Implement Transactional Refund Processing API `POST /api/v1/admin/refunds/process`.
...
- [ ] **T062** `[P]` `[Phase 12]` `[US4]` Implement Refund Details API `GET /api/v1/admin/refunds/:id`.
...
- [ ] **T063** `[Phase 13]` `[US1]` Implement Audit Logger Service `AuditService.logAction` in `backend/src/services/admin/audit.service.ts`.
...
- [ ] **T064** `[P]` `[Phase 13]` `[US1]` Implement Audit Logs Inspection API `GET /api/v1/admin/audit-logs`.
...
- [ ] **T065** `[P]` `[Phase 13]` `[US1]` Implement Sensitive Data Redaction in Audit Payload Serialization.
...
- [ ] **T066** `[P]` `[Phase 14]` Write Admin Authentication & Authorization Middleware Unit Tests in `backend/tests/admin/auth.test.ts`.
...
- [ ] **T067** `[P]` `[Phase 14]` Write Product Catalog API Integration Tests in `backend/tests/admin/products.test.ts`.
...
- [ ] **T068** `[P]` `[Phase 14]` Write Inventory Stock Adjustment & Concurrency Tests in `backend/tests/admin/inventory.test.ts`.
...
- [ ] **T069** `[P]` `[Phase 14]` Write Order Status State Machine Transition Tests in `backend/tests/admin/orders.test.ts`.
...
- [ ] **T070** `[P]` `[Phase 14]` Write After-Sales Refund Transaction Integration Tests in `backend/tests/admin/refunds.test.ts`.
...
- [ ] **T071** `[P]` `[Phase 14]` Write Privilege Escalation Protection Security Tests in `backend/tests/admin/rbac.test.ts`.
...
- [ ] **T072** `[Phase 14]` Execute Quickstart Validation Suite across all Admin Modules.
